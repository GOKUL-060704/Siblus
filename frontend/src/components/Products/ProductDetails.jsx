...
//     price: 120,
//     originalPrice: 150,
//     description: "THis is the stylish Jacket perfect for the any occasion",
//     brand: "FashionBrand",
//     material: "Leather",
//     sizes: ["S", "M", "L", "XL",],
//     colors: ["Red", "Black"],
...
const ProductDetails = ({productId }) => {
    ...
    if (!selectedSize || !selectedColor) {
        toast.error("Please select the size and color before adding to the cart", { duration: 2000 });
        return;
    }
        ...
        <div className='max-w-7xl mx-auto bg-white p-8 rounded-lg shadow-lg'>
            <div className='flex flex-col md:flex-row'>
                ...
                <div className="hidden md:flex flex-col space-y-4 mr-6">
                    {
                        selectedProduct.images.map((image, index) => (
                            <img
                                key={index}
                                src={image.url}
                                alt={image.altText || `Thambnail ${index + 1}`}
                ...
                <div className="md:w-1/2">
                    <div className='mb-4'>
                            <img src={mainImage} alt={selectedProduct.images[0].altText} className='w-full h-auto object-cover rounded-lg' />
                    </div>
                </div>
                {/* mobile thumbnails */}
                        ...
                        <div className='flex gap-2 mt-2'>
                            {selectedProduct.sizes.map((size) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded border ${selectedSize === size ? "border-4  border-black bg-black text-white" : "border-gray-300"}`}
                                >
                                    {size}
                                </button>
                            ))}
